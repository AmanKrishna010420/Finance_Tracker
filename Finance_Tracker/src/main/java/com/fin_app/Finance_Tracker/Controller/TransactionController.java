...
public class TransactionController {
    ...
    public ResponseEntity<Map<Integer,Integer>> getMonthlyIncome(@RequestParam("email") String userEmail) {
        return ResponseEntity.ok(transactionService.getMonthlyIncome(userEmail));
    }
